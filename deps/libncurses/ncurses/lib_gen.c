...
{
	T((T_CALLED("attr_get(%p,%p,%p)"), (const void *)a1, (const void *)a2, (const void *)z)); returnCode(((void)((((a1)) != (void *)0) ? (*((a1)) = (stdscr) ? (stdscr)->_attrs : 0) : (0)), (void)((((a2)) != (void *)0) ? (*((a2)) = (stdscr) ? (short)(stdscr)->_color : 0) : (0)), (0)));
}
...
{
	T((T_CALLED("attr_set(%s,%d,%p)"), _traceattr2(0,a1), a2, (const void *)z)); returnCode((((stdscr) ? ((stdscr)->_attrs = (((a1)) & ~((((1U) << 8) - 1U) << ((0) + 8))), (stdscr)->_color = ((a2))) : (0)), (0)));
}
...
NCURSES_EXPORT(int) (vw_scanw) (WINDOW * a1, NCURSES_CONST char * a2, va_list z)
{
...
{
	T((T_CALLED("wattr_get(%p,%p,%p,%p)"), (const void *)a1, (const void *)a2, (const void *)a3, (const void *)z)); returnCode(((void)(((a2) != (void *)0) ? (*(a2) = (a1) ? (a1)->_attrs : 0) : (0)), (void)(((a3) != (void *)0) ? (*(a3) = (a1) ? (short)(a1)->_color : 0) : (0)), (0)));
}


NCURSES_EXPORT(int) (wattr_set) (WINDOW * a1, attr_t a2, short a3, void * z)
{
	T((T_CALLED("wattr_set(%p,%s,%d,%p)"), (const void *)a1, _traceattr2(1,a2), a3, (const void *)z)); returnCode((((a1) ? ((a1)->_attrs = ((a2) & ~((((1U) << 8) - 1U) << ((0) + 8))), (a1)->_color = (a3)) : (0)), (0)));
}

...
{
 if (!((((*((SP)->_current_attr))).attr) == (((*c)).attr) && ((((*((SP)->_current_attr))).ext_color) ? (((*((SP)->_current_attr))).ext_color) : ((int)((((unsigned long)((((*((SP)->_current_attr))).attr)) & ((((1U) << 8) - 1U) << ((0) + 8))) >> 8)))) == ((((*c)).ext_color) ? (((*c)).ext_color) : ((int)((((unsigned long)((((*c)).attr)) & ((((1U) << 8) - 1U) << ((0) + 8))) >> 8)))))) { vid_attr((((*c)).attr), (short) ((((*c)).ext_color) ? (((*c)).ext_color) : ((int)((((unsigned long)((((*c)).attr)) & ((((1U) << 8) - 1U) << ((0) + 8))) >> 8)))), 0); };
}
